...
public class Register extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        p1.setMinimumSize(new java.awt.Dimension(400, 300));
        ...
        p2.setMinimumSize(new java.awt.Dimension(400, 300));
        p2.setPreferredSize(new java.awt.Dimension(600, 100));
...
//      Code to convert java.util.Date to String  
        ...
        java.sql.Date sdt=new java.sql.Date(dt.getTime());
          ...
          try{
              ...
              db.DBConnect.insertuser.setDate(3, sdt);
              ...
              JOptionPane.showMessageDialog(this, "Your details are saved into Database.");
          }catch(Exception ex){}
        }
